...
import { PropertyAttributes, UserAttributes } from '../../types'
...
const DividerComponent: FC<IDividerComponentProps> = ({ children }) => (
...
interface PropertyDetailsProps extends PropertyAttributes, UserAttributes {}

const PropertyDescription: FC<PropertyDetailsProps> = ({
  title,
  description,
  rent,
  size,
          ...
          <Grid item xs={12} md={8}>
            <Stack spacing={2}>
              ...
              <Typography variant="subtitle2" color="text.secondary">
                {`Property for rent in ${state}, ${location}, ${street}.`.toUpperCase()}
              </Typography>

              <Typography variant="subtitle2" color="text.secondary">
                {`Property Size: ${size} sqm`}
              </Typography>
            </Stack>
